...
import modelo.gestores.gestorEstudiantes;
import modelo.gestores.gestorGrupos;
...
public class servicioProcesoCrearGrupo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            gestorGrupos.obtenerInstancia().creaGrupo(com);
            com.setId(gestorGrupos.obtenerInstancia().obtenerIDGrupoPorNombre(nombre));
            int id= com.getId();
            ...
            //--------- obtener datos de usuario
                ...
                Estudiante est= GE.getEstudiante(idUsuario);
